...
use epl_common::database::entities::prelude::{Channel, Mention, Message, Pin, User};
            ...
            for i in pins_model {
                match i.1 {
                    ...
                    Some(message) => {
                        ...
                        pins.push(generate_message_struct(message, author, refed_message, mentioned_users, true));
                    }
                }
            }
